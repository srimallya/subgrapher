...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  browser: {
    ...
    mailSearchLocalThreads: (query = '', limit = 40, forceRefresh = false, accountName = '', accountId = '', mailboxPath = '', smartView = '') => ipcRenderer.invoke('browser:mailSearchLocalThreads', {
      query,
      limit,
    ...
    mailListMailboxes: (accountId = '') => ipcRenderer.invoke('browser:mailListMailboxes', { accountId }),
    mailSaveAccount: (account = {}) => ipcRenderer.invoke('browser:mailSaveAccount', account || {}),
    mailStartGoogleOAuth: (payload = {}) => ipcRenderer.invoke('browser:mailStartGoogleOAuth', payload || {}),
    mailSendMessage: (accountId = '', message = {}) => ipcRenderer.invoke('browser:mailSendMessage', {
      accountId,
      message,
    }),
    mailSaveDraft: (accountId = '', message = {}) => ipcRenderer.invoke('browser:mailSaveDraft', {
      accountId,
      message,
    }),
    ...
    mailUpdateThreadState: (threadId = '', patch = {}) => ipcRenderer.invoke('browser:mailUpdateThreadState', { threadId, patch }),
    mailMoveThread: (threadId = '', targetRole = '') => ipcRenderer.invoke('browser:mailMoveThread', { threadId, targetRole }),
    mailDeleteThread: (threadId = '') => ipcRenderer.invoke('browser:mailDeleteThread', { threadId }),
    mailPickAttachments: () => ipcRenderer.invoke('browser:mailPickAttachments'),
    ...
    referenceRankingState: (payload = {}) => ipcRenderer.invoke('browser:referenceRankingState', payload || {}),
    referenceRankingRecord: (payload = {}) => ipcRenderer.invoke('browser:referenceRankingRecord', payload || {}),
  ...
  notes: {
    ...
    get: (noteId = '', options = {}) => ipcRenderer.invoke('notes:get', { noteId, ...(options || {}) }),
